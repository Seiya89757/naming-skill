...
如果你：
- 是某个方言的母语者，发现 [references/dialect-pitfalls.md](references/dialect-pitfalls.md) 里漏了重要雷区
- 是命理界从业者，发现 SKILL.md 的命理处理有误
- 用了 skill 之后发现某个流程不顺，想给反馈

直接提 issue 或 PR 就好。**特别欢迎方言雷区补充**，每一条都可能拯救某个孩子被嘲笑的一辈子。
...
- 灵感来源于"起名 app 都不查方言"这个真实痛点
- 命理流派分析参考自《子平真诠》《滴天髓》等传统命理典籍
- 方言雷区库初版基于公开方言资料 + 网络真实案例（持续维护中）
- 感谢早期内测家庭的真实反馈，帮我把"协商模式"从想法变成可用功能

---

## 📬 联系

- Issues: [GitHub Issues](https://github.com/Seiya89757/naming-skill/issues)
- 特别欢迎：**方言雷区补充** / **真实使用反馈** / **流派支持建议**
